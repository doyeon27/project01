...
## 프로젝트 후기
저의 첫 프로젝트를 진행하며 느낀점은, 팀원들 간의 소통이 매우 중요하다는걸 느꼈습니다.<br>
<br>
작은 문제점이나 추가하고싶은 부분에 대해 의견이 적어서 원활하게 프로젝트 진행이 되지<br>
<br>
않았던 일이 있었습니다. <br>
<br>
그래도 팀원들 모두 땀흘리며 열심히 만든 프로젝트 결과물을 보니 뿌듯하면서 한편으로는 이제 개발자로서의 시작이다 라는 것을 느끼게 해준 프로젝트 였습니다.<br>
